 ...
 * @param {Array} apikeys
 */
function addSite(router, { providers, sessionStore, cacheControl = {} }, site, apikeys) {
  ...
  if (!_.isEmpty(providers)) {
    auth.init(siteRouter, providers, site, sessionStore, apikeys);
  }
 ...
 *   require('./routes)(app);
 */
function loadFromConfig(router, providers, sessionStore, cacheControl, apikeys) {
